fn main() {
    ...
    c_config.compile("tree-sitter-arduino");

    println!("cargo:rustc-check-cfg=cfg(with_highlights_query)");
    if !"node_modules/tree-sitter-c/queries/highlights.scm".is_empty() && std::path::Path::new("node_modules/tree-sitter-c/queries/highlights.scm").exists() {
    ...
    if !"node_modules/tree-sitter-c/queries/tags.scm".is_empty() && std::path::Path::new("node_modules/tree-sitter-c/queries/tags.scm").exists() {
